...
trex1 = pygame.image.load('assets/trex3.png')
trex2 = pygame.image.load('assets/trex3.png')
trex3 = pygame.image.load('assets/trex1.png')
ob1 = pygame.image.load('assets/ob2.png')
ob2 = pygame.image.load('assets/ob2.png')
chao = pygame.image.load('assets/g1.png')
# Posicionamento do T-Rex
trex_x = 100
trex_y = 300
# Velocidade, gravidade e pulo
vel_y = 0
gravidade = 1
pulando = False
# Posição do chão
...
# Quando o boneco quer pular/subir, sempre o numero sera negativo.
