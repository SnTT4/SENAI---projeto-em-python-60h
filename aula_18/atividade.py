...
def multiplicar():
    ...
    n2 = float(numero2.get())
    multiplicar = n1 * n2
    resultado.config(text = f'{multiplicar}')

def dividir():
    n1 = float(numero1.get())
    n2 = float(numero2.get())
    dividir = n1 / n2
    resultado.config(text = f'{dividir}')
...
btnn = tk.Button(root, text = 'X', command=multiplicar )
btnn.grid(row = 9, column = 2, pady = 10, padx= 10 )

btnnn = tk.Button(root, text = '/', command=dividir)
btnnn.grid(row = 10, column= 2, pady = 10, padx=10)
root.mainloop()
# -----------------------------------------------
